// Example 3D ecosystem configuration for the evoconf_single-map_x100_noosc_kuzudb template
// This demonstrates 3D projection service configuration for quality diversity evolution runs
...
export default {
  apps: [
    ...
    {
      // KEY DIFFERENCE: 3D projection with different parameters
      name: "kromosynth-evaluation-socket-server_projection_pca_quantised",
      interpreter: '/Users/bjornpjo/Developer/apps/kromosynth-evaluate/.venv/bin/python3',
      cwd: '/Users/bjornpjo/Developer/apps/kromosynth-evaluate/evaluation/unsupervised',
      script: "projection_quantised.py",
      args: "--host 127.0.0.1 --dimensions 3 --dimension-cells 22", // 3D with 22 cells per dimension
